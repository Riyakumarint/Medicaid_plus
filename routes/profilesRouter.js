...
router.patch('/updateMedicalHistory_doc/:userId',auth, profilesCtrl.updateMedicalHistory_doc)
...
router.post('/addCurrMedicines_doc/:ID',auth, profilesCtrl.addCurrMedicines_doc)
router.post('/deleteCurrMedicines',auth, profilesCtrl.deleteCurrMedicines)
router.post('/deleteCurrMedicines_doc/:ID',auth, profilesCtrl.deleteCurrMedicines_doc)
...
router.post('/deleteMedCondition_doc/:id',auth, profilesCtrl.deleteMedCondition_doc)
...
router.get('/getMedicalProfile_doc/:userID',auth, profilesCtrl.getMedicalProfile_user)
