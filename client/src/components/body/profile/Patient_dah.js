      ...
      useEffect(() => {
          const getpiedata= ()=>{
            ...
            for(var i = 0; i < appointments.length; i++) {
                ...
                if((new Date(appointments[i].meetingDetail).toDateString())===l1.toDateString()){
                    a1++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l2.toDateString()){
                    a2++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l3.toDateString()){
                    a3++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l4.toDateString()){
                    a4++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l5.toDateString()){
                    a5++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l6.toDateString()){
                    a6++;
                }
                else if((new Date(appointments[i].meetingDetail).toDateString())===l7.toDateString()){
                    a7++;
                }
            }
            ...
            setPieData2({labels:['Active','Inactive'],
            datasets:[{
                label:'Active vs Inactive',
                data:[c,d],
                backgroundColor:[
