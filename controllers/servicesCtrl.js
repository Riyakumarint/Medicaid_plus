...
const servicesCtrl = {
    ...
    bookLabTest: async (req, res) =>{
        try {
            ...
            const {name, medicalId, patientID, testName, mobile, address, status} = req.body.bookingDetail;

            const newLabTest = new LabTest({name, medicalId, patientID, testName, mobile, address, status})
    ...
    updateLabTest: async(req, res) =>{
        try {
            const {name, medicalId, patientID, testName, mobile, address, status} = req.body;
    ...
    bookAmbulance: async (req, res) =>{
        try {
            const {name, medicalId, patientID, mobile, address, status} = req.body.bookingDetail;

            const newAmbulance = new Ambulance({name, medicalId, patientID, mobile, address, status})
